...
@Component({
  selector: 'evo-loading-bar',
  templateUrl: './evo-loading-bar.component.html',
  styleUrls: ['./evo-loading-bar.component.scss'],
...
export class EvoLoadingBarComponent implements OnInit, OnChanges, OnDestroy {
