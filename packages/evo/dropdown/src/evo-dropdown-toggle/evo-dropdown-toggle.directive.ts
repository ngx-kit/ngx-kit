...
@Directive({
  selector: '[evoDropdownToggle]',
  exportAs: 'toggle',
})
export class EvoDropdownToggleDirective {
  @Input() evoDropdownToggle: TemplateRef<any>;
  ...
  show() {
    ...
    const portal = new TemplatePortal(this.evoDropdownToggle, this.vcr);
