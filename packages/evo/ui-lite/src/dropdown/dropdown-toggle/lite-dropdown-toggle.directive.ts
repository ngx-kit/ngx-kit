...
@Directive({
  selector: '[liteDropdownToggle]',
  exportAs: 'toggle',
})
export class LiteDropdownToggleDirective {
  @Input() liteDropdownToggle: TemplateRef<any>;
  ...
  show() {
    ...
    const portal = new TemplatePortal(this.liteDropdownToggle, this.vcr);
