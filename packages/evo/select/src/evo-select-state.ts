import { UiSelectItem, UiSelectItemView } from './meta';
...
export class EvoSelectState<M> {
   ...
   */
  readonly items = new BehaviorSubject<UiSelectItem<M>[]>([]);

  /**
   * Prepared view of items list.
   */
  readonly itemsView = new BehaviorSubject<UiSelectItemView<M>[]>([]);
