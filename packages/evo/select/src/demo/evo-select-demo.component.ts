...
import { UiSelectFilterFn, UiSelectItem, UiSelectListStateAsyncSourceFn, UiSelectListStateSourceFn } from '../meta';

/**
 * @demo
 */
@Component({
  templateUrl: './evo-select-demo.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class EvoSelectDemoComponent implements OnInit {
  model = 1;
