...
import { EvoClass } from '../class/evo-class';

export const KIT_CHECK_VALUE_ACCESSOR: any = {
  provide: NG_VALUE_ACCESSOR,
  useExisting: forwardRef(() => EvoCheckDirective),
  multi: true,
};
...
export class EvoCheckDirective implements OnChanges, ControlValueAccessor {
  /**
  ...
  constructor(@Host() private cl: EvoClass) {
  }
